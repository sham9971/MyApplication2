...
public class SettingsActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       userInfoDisplay(profileImageView,fullNameEditText,userPhoneEditText,addressEditText,passwordEditText,profileChangeTextBtn,closeTextBtn,saveTextButton);
    ...
    private void userInfoDisplay(final CircleImageView profileImageView, final EditText fullNameEditText,EditText passwordEditText, EditText userPhoneEditText, EditText addressEditText, TextView profileChangeTextBtn, TextView closeTextBtn, TextView saveTextButton)
    {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                    if(dataSnapshot.child("image").exists())
                    {
                        ...
                        fullNameEditText.setText(phone);
                        fullNameEditText.setText(address);
                        fullNameEditText.setText(pass);
